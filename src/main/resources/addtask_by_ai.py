...
print("Ngày giờ định dạng:", formatted_date_time)
...
based = "hiện tại chúng tôi gọi API của bạn để nhận đầu vào người dùng (đầu vào là 1 tiêu đề của 1 task trong dự án smart-to-do-list của chúng tôi ), chúng tôi cần bận phân tích đầu vào đó để biết đâu là title,dueDate và dựa vào đầu vào hãy sinh ra description, và Priority,  "
